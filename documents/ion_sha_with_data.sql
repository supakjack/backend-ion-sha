...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 01, 2020 at 07:02 PM
...
(1, '0336420344', 1, 'เพชรเกษม', 1, 1, 1, 1);
...
CREATE TABLE `applications` (
  ...
  `app_update_date` datetime DEFAULT NULL COMMENT 'วันที่แก้ไขล่าสุด 2020-01-01 00:00:01',
...
(3, 'กกกก001', '2019-12-31 05:11:57', '2020-12-31 00:00:00', 1, 1, 1, 1);
...
(3, 125000, 'สมชาย จงจอหอ', 223640611, 'พ่อ', 1, 1, 3);
...
(1, 'ขายตรง', 551260788, 125325, 1, 3, 1);
...
CREATE TABLE `profiles` (
  ...
  `pro_id_card` int(13) DEFAULT NULL COMMENT 'หมายเลขบัตประจำตัวประชาชน เช่น 1608806315876',
...
INSERT INTO `profiles` (`pro_id`, `pro_first_th_name`, `pro_last_th_name`, `pro_first_en_name`, `pro_last_en_name`, `pro_id_card`, `pro_race`, `pro_bod`, `pro_nation_id`, `pro_blood_id`, `pro_prefix_id`, `pro_province_id`, `pro_religion_id`) VALUES
(1, 'มาโนทย์', 'รักษ์ดี', 'manote', 'lukdee', 2147483647, 'ไทย-ลาว', '0000-00-00 00:00:00', 1, 1, 1, 1, 1),
(2, 'มานี', 'รักษ์ดี', 'manee', 'lukdee', 2147483647, 'ไทย-ลาว', '2020-12-10 00:00:00', 1, 1, 1, 1, 1);
...
(1, '0101001', '2020-01-01 00:00:00', '2020-02-01 00:00:00', 1, 10, 0, 'y', 1, 1, 1, 1, 1, 1);
...
--
ALTER TABLE `address`
  MODIFY `adr_id` int(6) NOT NULL AUTO_INCREMENT COMMENT 'หมายเลขแฟ้มเก็บที่อยู่ เช่น 1 ,2 ,3', AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `address_tab`
--
ALTER TABLE `address_tab`
  MODIFY `adt_id` int(6) NOT NULL AUTO_INCREMENT COMMENT 'หมายเลขข้อมูลส่วนของที่อยู่', AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT for table `address_type`
--
ALTER TABLE `address_type`
  MODIFY `art_id` int(6) NOT NULL AUTO_INCREMENT COMMENT 'หมายเลขประเภทที่อยู่', AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `applications`
--
ALTER TABLE `applications`
  MODIFY `app_id` int(6) NOT NULL AUTO_INCREMENT COMMENT 'หมายเลขใบสมัคร  เช่น   1 ,2 ,3', AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT for table `applications_status`
--
ALTER TABLE `applications_status`
  MODIFY `aps_id` int(6) NOT NULL AUTO_INCREMENT COMMENT 'หมายเลขสถานะใบสมัคร เช่น  1 ,2 ,3	', AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `classes`
--
ALTER TABLE `classes`
  MODIFY `cls_id` int(6) NOT NULL AUTO_INCREMENT COMMENT 'หมายเลขห้องเรียน เช่น   1 ,2 ,3', AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `courses`
--
ALTER TABLE `courses`
  MODIFY `crs_id` int(6) NOT NULL AUTO_INCREMENT COMMENT 'หมายเลขหลักสูตร เช่น   1 ,2 ,3', AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT for table `education_levels`
--
ALTER TABLE `education_levels`
  MODIFY `edl_id` int(6) NOT NULL AUTO_INCREMENT COMMENT 'หมายเลขระดับการศึกษา เช่น  1 ,2 ,3	', AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `parent_sta_tab`
--
ALTER TABLE `parent_sta_tab`
  MODIFY `pst_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'หมายเลขข้อมูลส่วนของสถานะผู้ปกครอง', AUTO_INCREMENT=4;
...
--
ALTER TABLE `parent_tab`
  MODIFY `pat_id` int(6) NOT NULL AUTO_INCREMENT COMMENT 'หมายเลขข้อมูลส่วนของผู้ปกครอง', AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `parent_type`
--
ALTER TABLE `parent_type`
  MODIFY `prt_id` int(6) NOT NULL AUTO_INCREMENT COMMENT 'หมายเลขประเภทผู้ปกครอง', AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `profiles`
--
ALTER TABLE `profiles`
  MODIFY `pro_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'หมายเลขแฟ้มเก็บประวัติ เช่น 1 ,2 ,3', AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT for table `register`
--
ALTER TABLE `register`
  MODIFY `reg_id` int(6) NOT NULL AUTO_INCREMENT COMMENT 'หมายเลขการลงทะเบียน เช่น  1 ,2 ,3	', AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `register_status`
--
ALTER TABLE `register_status`
  MODIFY `rgs_id` int(6) NOT NULL AUTO_INCREMENT COMMENT 'หมายเลขสถานะการลงทะเบียน เช่น  1 ,2 ,3', AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `student_tab`
--
ALTER TABLE `student_tab`
  MODIFY `stt_id` int(6) NOT NULL AUTO_INCREMENT COMMENT 'หมายเลขข้อมูลส่วนของนักเรียน	', AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `terms`
--
ALTER TABLE `terms`
  MODIFY `tem_id` int(6) NOT NULL AUTO_INCREMENT COMMENT 'หมายเลขเทอมการศึกษา เช่น   1 ,2 ,3 	', AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `users`
--
ALTER TABLE `users`
  MODIFY `usr_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'หมายเลขผู้ใช้งาน เช่น  1 ,2 ,3', AUTO_INCREMENT=2;
...
--
ALTER TABLE `years`
  MODIFY `yrs_id` int(6) NOT NULL AUTO_INCREMENT COMMENT 'หมายเลขปีการศึกษา เช่น  1 ,2 ,3', AUTO_INCREMENT=2;
